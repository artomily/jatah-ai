...
export function LogoMark({ className }: { className?: string }) {
  return (
    ...
    >
      <rect x="3" y="3" width="18" height="18" rx="5.5" className="fill-primary" />
      <rect x="8" y="7.5" width="3" height="9" rx="1.5" className="fill-primary-foreground" />
      <rect x="13" y="11.5" width="3" height="5" rx="1.5" className="fill-primary-foreground/60" />
    </svg>
  );
}
